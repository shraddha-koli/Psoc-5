...
static void CharLCD_1_WrCntrlNib(uint8 nibble) 
{
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    *  Function Name: CharLCD_1_PrintInt32
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        uint8 shift = CharLCD_1_32_BIT_SHIFT;
        ...
        while (shift != 0u)
        {
            ...
            */
            shift -= CharLCD_1_8_BIT_SHIFT;
            
            /* Print 8 bits of uint32 hex number */
            CharLCD_1_PrintInt8((uint8) ((uint32) (value >> shift)));
        }
    }
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    *  Function Name: CharLCD_1_PrintU32Number
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        uint8 tmpDigit;
        char8 number[CharLCD_1_NUMBER_OF_REMAINDERS_U32 + 1u];
        uint8 digIndex = CharLCD_1_NUMBER_OF_REMAINDERS_U32;
        ...
        */
        ...
        while(value >= CharLCD_1_TEN)
        {
            ...
            */
            tmpDigit = (uint8) (((uint8) (value % CharLCD_1_TEN)) + (uint8) CharLCD_1_ZERO_CHAR_ASCII);
        ...
        */
        ...
        /* Print out number */
        CharLCD_1_PrintString(&number[digIndex]);
    }
