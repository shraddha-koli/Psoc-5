...
*
* \funcusage
*  \snippet VoltInput_SUT.c usage_VoltInput_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet VoltInput_SUT.c usage_VoltInput_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet VoltInput_SUT.c usage_VoltInput_Read  
*******************************************************************************/
...
* preferred VoltInput_Read() API because the 
* VoltInput_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet VoltInput_SUT.c usage_VoltInput_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: VoltInput_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use VoltInput_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - VoltInput_0_INTR       (First pin in the list)
    *  - VoltInput_1_INTR       (Second pin in the list)
    *  - ...
    *  - VoltInput_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet VoltInput_SUT.c usage_VoltInput_SetInterruptMode
    *******************************************************************************/
    void VoltInput_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & VoltInput_0_INTR) != 0u) 
		{ 
			 VoltInput_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet VoltInput_SUT.c usage_VoltInput_ClearInterrupt
    *******************************************************************************/
