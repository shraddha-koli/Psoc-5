...
// CharLCD_v2_20(ConversionRoutines=true, CUSTOM0=0,E,8,8,8,E,0, CUSTOM1=0,A,A,4,4,4,0, CUSTOM2=0,E,A,E,8,8,0, CUSTOM3=0,E,A,C,A,A,0, CUSTOM4=0,E,8,C,8,E,0, CUSTOM5=0,E,8,E,2,E,0, CUSTOM6=0,E,8,E,2,E,0, CUSTOM7=0,4,4,4,0,4,0, CustomCharacterSet=3, TypeReplacementString=uint8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONFIG_TITLE=CharLCD_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CharLCD_1, CY_INSTANCE_SHORT_NAME=CharLCD_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CharLCD_1, )
...
module top ;
	...
	wire [0:0] tmpOE__mySCL_net;
	wire [0:0] tmpFB_0__mySCL_net;
	wire [0:0] tmpIO_0__mySCL_net;
	wire [0:0] tmpINTERRUPT_0__mySCL_net;
	electrical [0:0] tmpSIOVREF__mySCL_net;
	...
	cy_psoc3_pins_v1_10
		...
		mySCL
		 (.oe(tmpOE__mySCL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__mySCL_net[0:0]}),
		  .io({tmpIO_0__mySCL_net[0:0]}),
		  .siovref(tmpSIOVREF__mySCL_net),
		  .interrupt({tmpINTERRUPT_0__mySCL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__mySCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__mySDA_net;
	wire [0:0] tmpFB_0__mySDA_net;
	wire [0:0] tmpINTERRUPT_0__mySDA_net;
	electrical [0:0] tmpSIOVREF__mySDA_net;

	cy_psoc3_pins_v1_10
		#(.id("8b411c4b-9799-41d1-a4bc-ef8ff89cee6b"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		mySDA
		 (.oe(tmpOE__mySDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__mySDA_net[0:0]}),
		  .io({Net_66}),
		  .siovref(tmpSIOVREF__mySDA_net),
		  .interrupt({tmpINTERRUPT_0__mySDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__mySDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
